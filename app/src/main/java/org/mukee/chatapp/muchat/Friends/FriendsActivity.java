package org.mukee.chatapp.muchat.Friends;
...
import org.mukee.chatapp.muchat.Chat.ChatActivity;
import org.mukee.chatapp.muchat.Profile.ProfileActivity;
import org.mukee.chatapp.muchat.R;
import org.mukee.chatapp.muchat.Model.Friends;
    ...
    private void showPeopleList(){
        ...
        FirebaseRecyclerAdapter<Friends, FriendsVH> recyclerAdapter = new FirebaseRecyclerAdapter<Friends, FriendsVH>(recyclerOptions) {
            ...
            protected void onBindViewHolder(@NonNull final FriendsVH holder, int position, @NonNull Friends model) {
                holder.date.setText(String.format("Friendship date -\n%s", model.getDate()));
